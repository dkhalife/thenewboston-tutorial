...
public class Email extends Activity implements View.OnClickListener {
	...
	public void onClick(View v) {
		...
		String message = "Well hello " + name + " I just wanted to say " + beginning + ".  Not only that but I hate when you " + stupidAction
				+ ", that just really makes me crazy.  I just want to make you " + hatefulAct + ".  Welp, thats all I wanted to chit-chatter about, oh and"
		...
		sendEmail.putExtra(android.content.Intent.EXTRA_SUBJECT, "Contact Email");
